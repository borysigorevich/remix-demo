...
interface SnackNotificationProps extends Omit<NotificationProps, 'variant'> {
  noClose?: boolean;
...
export const SnackNotification = React.forwardRef<HTMLDivElement, SnackNotificationProps>(
  (
